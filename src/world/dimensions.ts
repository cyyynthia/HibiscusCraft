...
Overworld.write(NbtType.STRING, 'name', 'minecraft:overworld')
...
Nether.write(NbtType.STRING, 'name', 'minecraft:the_nether')
...
export const TheEnd = new NbtCompound()
TheEnd.write(NbtType.STRING, 'name', 'minecraft:the_end')
TheEnd.write(NbtType.BYTE, 'ultrawarm', 0)
TheEnd.write(NbtType.BYTE, 'natural', 0)
TheEnd.write(NbtType.BYTE, 'shrunk', 0)
TheEnd.write(NbtType.BYTE, 'piglin_safe', 0)
TheEnd.write(NbtType.BYTE, 'respawn_anchor_works', 0)
TheEnd.write(NbtType.BYTE, 'bed_works', 0)
TheEnd.write(NbtType.BYTE, 'has_raids', 1)
TheEnd.write(NbtType.BYTE, 'has_skylight', 0)
TheEnd.write(NbtType.BYTE, 'has_ceiling', 0)
TheEnd.write(NbtType.INT, 'fixed_time', 6000)
TheEnd.write(NbtType.FLOAT, 'ambient_light', 0)
TheEnd.write(NbtType.INT, 'logical_height', 256)
TheEnd.write(NbtType.STRING, 'infiniburn', 'minecraft:infiniburn_end')
